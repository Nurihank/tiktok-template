// contentGenerate01.js - İlk İçerik Üretimi (Kelime Kartları)
...
function getNextRunNumber() {
  const counterFile = 'run_counter_01.txt'
  let runNumber = 1
...
// --- Content Generate 01: Kelime Kartları ---
export async function runContentGenerate01() {
  console.log('🎯 Content Generate 01: Kelime Kartları başlatılıyor...')

  // Çalışma numarasını al
  const runNumber = getNextRunNumber()
  const mainOutputFolder = `content01_${runNumber}`
  ...
  console.log(
    `\n🌟 Content Generate 01 tamamlandı. Klasör: ${mainOutputFolder}`
  )
